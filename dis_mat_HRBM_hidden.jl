...
c = h5open("/home/anelmad/Desktop/stage-inria/code/HTreeRBM.jl/my_tree/HRBM_hidden_weight.h5", "r") do file
	    read(file, "a")
	end
p=c'
...
h5open("/home/anelmad/Desktop/stage-inria/code/HTreeRBM.jl/my_tree/dist_mat_HRBM_hidden.h5", "w") do file
